...
export class SeasonCourseControllerBase {
  constructor(
  ...
  @common.Post()
  @swagger.ApiCreatedResponse({ type: SeasonCourse })
  ...
  async create(
    @common.Body() data: SeasonCourseCreateInput
  ...
  @common.Get()
  @swagger.ApiOkResponse({ type: [SeasonCourse] })
  ...
  async findMany(@common.Req() request: Request): Promise<SeasonCourse[]> {
    const args = plainToClass(SeasonCourseFindManyArgs, request.query);
  ...
  async findOne(
    @common.Param() params: SeasonCourseWhereUniqueInput
  ...
  async update(
    @common.Param() params: SeasonCourseWhereUniqueInput,
    @common.Body() data: SeasonCourseUpdateInput
  ): Promise<SeasonCourse | null> {
    try {
